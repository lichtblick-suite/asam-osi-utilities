...
// Suppress deprecation warning — this example demonstrates the deprecated TXTH writer
...
#endif
    file_name += "_example_sv_txth_writer.txth";
...
auto RunExample() -> int {
    ...
    for (int i = 0; i < 10; ++i) {
        ...
        ground_truth->mutable_timestamp()->set_seconds(static_cast<int64_t>(timestamp / kNsPerSec));
